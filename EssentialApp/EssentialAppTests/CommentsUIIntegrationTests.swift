...
final class CommentsUIIntegrationTests: XCTestCase {
    ...
    func  test_loadCommentsCompletion_rendersSuccessfullyLoadedComments() {
        let comments0 = makeComment(message: "a message", username: "a username")
        let comments1 = makeComment(message: "another message", username: "another username")
        let (sut, loader) = makeSUT()
        ...
        assertThat(sut, isRendering: [comments0, comments1])
    }
